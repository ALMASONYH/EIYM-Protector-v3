...
namespace MasonProtector.Core
{
    internal class ControlFlowFlattening2Protection
    {
        ...
        private const int DISPATCH_TABLE_COUNT = 4;
        private const int DISPATCH_TABLE_SIZE = 128;
        private const int DISPATCH_KEY_COUNT = 8;
        private const int DISPATCH_DECODER_COUNT = 6;
        private const int DISPATCH_FAKE_COUNT = 8;
        private const int DISPATCH_DECOY_TYPE_COUNT = 4;
