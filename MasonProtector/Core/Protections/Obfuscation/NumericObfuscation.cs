...
namespace MasonProtector.Core
{
    internal class NumericObfuscationProtection
    {
        ...
        private const int KEY_FIELD_COUNT = 12;
        private const int CIPHER_TABLE_SIZE = 160;
        private const int CIPHER_TABLE_COUNT = 6;
        private const int DECODER_METHOD_COUNT = 8;
        private const int FAKE_METHOD_COUNT = 6;
