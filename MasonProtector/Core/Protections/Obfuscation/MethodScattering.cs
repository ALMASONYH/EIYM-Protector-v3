...
namespace MasonProtector.Core
{
    internal class MethodScatteringProtection
    {
        ...
        private const int SCATTER_HOST_COUNT = 8;
        private const int SCATTER_BRIDGE_COUNT = 12;
        private const int SCATTER_FAKE_COUNT = 10;
        private const int SCATTER_FIELD_NOISE = 16;
        private const int SCATTER_DECOY_TYPE_COUNT = 4;
        ...
        private bool ScatterMethod(ModuleDef module, MethodDef method)
        {
            ...
            foreach (var local in method.Body.Variables)
                scattered.Body.Variables.Add(new Local(local.Type));
