...
namespace MasonProtector.Core
{
    internal class DelegateEncryptionProtection
    {
        ...
        private const int DELEGATE_POOL_COUNT = 6;
        private const int DELEGATE_FAKE_COUNT = 8;
        private const int DELEGATE_DECOY_FIELD_COUNT = 12;
        private const int DELEGATE_KEY_COUNT = 8;
        private const int DELEGATE_EVALUATOR_COUNT = 10;
