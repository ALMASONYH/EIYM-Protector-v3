...
namespace MasonProtector.Core
{
    internal class StringCompositionProtection
    {
        ...
        private const int CHAR_TABLE_COUNT = 6;
        private const int CHAR_TABLE_SIZE = 256;
        private const int BUILDER_METHOD_COUNT = 10;
        private const int FAKE_BUILDER_COUNT = 6;
        private const int KEY_FIELD_COUNT = 8;
        private const int CHAR_RESOLVER_COUNT = 8;
