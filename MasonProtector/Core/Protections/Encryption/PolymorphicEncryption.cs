...
namespace MasonProtector.Core
{
    internal class PolymorphicEncryptionProtection
    {
        ...
        private const int POLY_VAULT_COUNT = 8;
        private const int POLY_VAULT_SIZE = 192;
        private const int POLY_KEY_COUNT = 16;
        private const int POLY_DECODER_COUNT = 12;
        private const int POLY_FAKE_COUNT = 8;
        private const int POLY_SCRAMBLER_COUNT = 6;
        private const int POLY_MIXER_COUNT = 4;
        private const int POLY_CHAIN_LENGTH = 5;
