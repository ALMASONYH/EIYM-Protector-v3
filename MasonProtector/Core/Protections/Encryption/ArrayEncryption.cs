...
namespace MasonProtector.Core
{
    internal class ArrayEncryptionProtection
    {
        ...
        private const int CIPHER_KEY_COUNT = 12;
        private const int CIPHER_TABLE_COUNT = 6;
        private const int CIPHER_TABLE_SIZE = 192;
        private const int CIPHER_DECODER_COUNT = 10;
        private const int CIPHER_FAKE_COUNT = 8;
        private const int CIPHER_SCRAMBLER_COUNT = 6;
        private const int CIPHER_MIXER_COUNT = 4;
