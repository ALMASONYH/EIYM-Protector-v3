...
namespace MasonProtector.Core
{
    internal class TypeScramblerProtection
    {
        ...
        private const int ABSTRACT_TYPE_COUNT = 5;
        private const int INTERFACE_COUNT = 4;
        private const int SEALED_TYPE_COUNT = 4;
        private const int GENERIC_TYPE_COUNT = 3;
        private const int NESTED_DEPTH_MAX = 5;
        private const int CIRCULAR_PAIR_COUNT = 3;
        private const int ENUM_COUNT = 4;
        private const int EVENT_TYPE_COUNT = 3;
        private const int DELEGATE_TYPE_COUNT = 3;
        private const int OVERLOAD_SET_COUNT = 4;
