    ...
    internal class TokenConfusionProtection
    {
        ...
        private void InjectOverloadedMethods(ModuleDef module)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                int overloadCount = rng.Next(3, 7);
        ...
        private void InjectDummyModuleAttributes(ModuleDef module)
        {
            ...
            {
                "EIYM Protected Assembly", "Licensed Software",
                "Tamper Resistant", "Encrypted Runtime",
                "Integrity Verified", "Debug Protected"
            };

            int caCount = rng.Next(2, 4);
