...
namespace MasonProtector.Core
{
    internal class JunkCodeProtection
    {
        ...
        private void InjectJunkInstructions(ModuleDef module, MethodDef method)
        {
            ...
            int injectCount = Math.Min(rng.Next(1, 4), safe.Count);
