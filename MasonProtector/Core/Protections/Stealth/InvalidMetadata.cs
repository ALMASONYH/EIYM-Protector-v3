...
namespace MasonProtector.Core
{
    internal class InvalidMetadataProtection
    {
        ...
        private const int PHANTOM_TYPE_COUNT = 8;
        private const int PHANTOM_NESTING_DEPTH = 4;
        private const int PHANTOM_METHOD_COUNT = 12;
        private const int PHANTOM_FIELD_COUNT = 16;
        private const int GHOST_INTERFACE_COUNT = 6;
        private const int CONFUSION_ATTRIBUTE_COUNT = 10;
        private const int DECOY_RESOURCE_COUNT = 4;
        private const int TRAP_METHOD_COUNT = 8;
        private const int OVERLOAD_COUNT = 6;
        private const int DUMMY_GENERIC_COUNT = 4;
